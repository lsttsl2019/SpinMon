...
public class Item {
    ...
    public Item(int width, int heigth, Bitmap[] imgItem, int ex, int ey) {
    this.width=width;
    this.heigth=heigth;
    x=ex; y=ey;

    //종류
        //0:coin  1:gam 2:fast 3: protect 4: magnet 5: bomb 6: strong
        Random rnd= new Random();

        int n=rnd.nextInt(100); //0~99
        kind=n<65? 0 : n<66? 1: n<81? 2: n<84? 3: n<96? 4: n<97?5 : 6;  //확률 계산기
